...
class MugBallPickTaskSampler(PickTaskSampler):
    ...
    def _sample_task(self, env: CPUMujocoEnv) -> MugBallPickTask:
        ...
        # Fix robot qpos to the configured home pose (CommonSenseFrankaRobotConfig:
        # raised elbow, no noise) so every episode starts identically.
        ...
        # Setup cameras early so visibility checks below can render
