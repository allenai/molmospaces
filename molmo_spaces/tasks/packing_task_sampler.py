...
class PackingTaskSampler(PickAndPlaceTaskSampler):
    ...
    def add_auxiliary_objects(self, spec: MjSpec) -> None:
        ...
        # Deliberately defaults to the shallowest box (0.061m walls): taller boxes
        # put the place pose out of comfortable IK range and hide the contents
        # from the exo cameras. Set task_sampler_config.box_uids to sample others
        # (e.g. DEFAULT_BOX_UIDS for the full Box_1..Box_30 set).
        box_uids = task_sampler_config.box_uids or ["Box_11"]
