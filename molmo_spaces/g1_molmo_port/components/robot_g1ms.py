"""Compatibility shim -- the implementation moved to molmo_spaces/robots/g1_ported.py.
...
`molmo_spaces.robots.g1_ported`), which is where it is now being reshaped
...
from molmo_spaces.robots.g1_ported import (  # noqa: F401
    DEFAULT_QPOS,
    GRIPPER_CLOSED,
    GRIPPER_OPEN,
    JOINT_NAMES,
