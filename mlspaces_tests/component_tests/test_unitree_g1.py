...
def test_prepare_unitree_g1_dex1_smoke(tmp_path, monkeypatch):
    ...
    assert tabletop_datagen_config.task_sampler_config.pickup_workspace_size_xy == (0.16, 0.10)
    assert tabletop_datagen_config.task_sampler_config.place_workspace_center_xy == (0.42, 0.08)
    assert tabletop_datagen_config.task_sampler_config.place_workspace_size_xy == (0.10, 0.08)
    ...
    assert tabletop_datagen_config.policy_config.pregrasp_z_offset == 0.12
