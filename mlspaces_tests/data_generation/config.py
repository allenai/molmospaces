...
from molmo_spaces.configs.robot_configs import BaseRobotConfig, FloatingRUMRobotConfig
...
class FrankaPickDroidTestConfig(FrankaPickDroidDataGenConfig):
    ...
    def model_post_init(self, _context: Any) -> None:
        ...
        self.task_sampler_config.pickup_types = ["TissueBox"]  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
        ...
        assert self.robot_config.action_noise_config is not None
...
class FrankaPickRandomizedTestConfig(FrankaPickRandomizedDataGenConfig):
    ...
    def model_post_init(self, _context: Any) -> None:
        ...
        self.task_sampler_config.max_tasks = 10
        self.task_sampler_config.pickup_types = ["TissueBox"]  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
        self.task_sampler_config.robot_object_z_offset_random_min = 0.0  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
        self.task_sampler_config.robot_object_z_offset_random_max = 0.0  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
...
class FrankaPickAndPlaceDroidTestConfig(FrankaPickAndPlaceDroidDataGenConfig):
    def model_post_init(self, _context: Any) -> None:
        ...
        if isinstance(self.task_sampler_config, PickTaskSamplerConfig):
        ...
        self.policy_config.place_z_offset = 0.02  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
    ...
    def model_post_init(self, _context: Any) -> None:
        ...
        for camera in self.camera_config.cameras:
            if hasattr(camera, "pos_noise_range"):
                camera.pos_noise_range = (0.0, 0.0)  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
            if hasattr(camera, "orientation_noise_degrees"):
                camera.orientation_noise_degrees = 0.0  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
            if hasattr(camera, "lookat_noise_range"):
                camera.lookat_noise_range = (0.0, 0.0)  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
...
class RUMPickTestConfig(RUMPickDataGenConfig):
    ...
    def model_post_init(self, _context: Any) -> None:
        ...
        assert self.camera_config is not None
        self.camera_config.img_resolution = (624, 352)
...
class RUMOpenTestConfig(OpeningBaseConfig):
    ...
    def model_post_init(self, _context: Any) -> None:
        ...
        self.task_type = "open"
        self.task_sampler_config.target_initial_state_open_percentage = 0.0  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore

        # Use iTHOR for testing instead of ProcTHOR
        self.scene_dataset = "ithor"

        # Set target type to drawer
        self.task_sampler_config.pickup_types = ["drawer"]  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
        ...
        self.task_sampler_config.robot_object_z_offset = 0  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
        self.task_sampler_config.base_pose_sampling_radius_range = (0, 0.8)  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
        self.task_sampler_config.robot_safety_radius = 0.2  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore

        # Open/close specific policy settings (similar to OpenClosePlannerPolicyConfig)
        self.policy_config.grasp_pos_cost_weight = 1.0  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
...
class RUMCloseTestConfig(OpeningBaseConfig):
    ...
    def model_post_init(self, _context: Any) -> None:
        ...
        self.task_sampler_config.target_initial_state_open_percentage = 0.5  # pyright: ignore[reportAttributeAccessIssue] # ty: ignore
