...
# Prompts and response schema are shared with the GeminiCAP policy path so the
# offline eval and the in-policy pointing stay in lockstep.
from molmo_spaces.utils.object_permanence_pointing import (  # noqa: E402
    MIDAIR_DESCRIPTION,
    RESPONSE_SCHEMA,
    SCENE_DESCRIPTION,
    TASK_INSTRUCTION,
