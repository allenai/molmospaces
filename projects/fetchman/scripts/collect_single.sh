...
# wins over the cwd, because python puts the *script's* directory on sys.path,
# not the working directory) -- which is how you get a ModuleNotFoundError for
# a file that is plainly sitting right there.
